...
\section{More on decompositions}
	...
	% 	Equation (5.8) in \cite{LedouxCheegerPoincareConstant} shows that for log-concave $\mu$, $h_p \sim \zeta_p$.\footnote{Even for $\mu$ that is not log-concave, it is true that $h_p \gtrsim \zeta_p$.} Further, more relevant to our interests, $\zeta_p \sim \psi_p^2$.\\
