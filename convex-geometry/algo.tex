...
\begin{proof}
	...
	The above implies that if we show uniform boundedness of the $(\psi_i)$ on $[s,t]$, then (uniform) equicontinuity follows as well. And indeed, the $(\psi_i)$ are uniformly bounded on any $[s,t]$ due to concavity together with the fact that
	\[ \int_s^t \psi_i(t)^{n-1}\d{t} \leq 1. \]
	% *** HOW??? ***
