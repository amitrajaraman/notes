...
Recall that we start with the uniform distribution on $B_2^n$. To estimate $M$ (in the context of \Cref{cor 4.23}),
\begin{align*}
...
\[ \eta = \left(1-\frac{\Phi^2}{2}\right)^t < e^{-t\Phi^2/2} \] % \leq m^{-128n/\varepsilon^2} \]
