...
\begin{fcon}[KLS Conjecture]
	...
	\[ \psi_p \geq c \inf_{H\text{ is a halfspace}} \frac{p(\partial H)}{\min\{p(H),p(\Rn\setminus H)\}}. \]
\end{fcon}
...
In this context, the \nameref{con: kls conjecture} says 
...
Equivalently, it says that there is not too much volume right around the origin.

\begin{definition}[Isotropic Slicing Constant]
