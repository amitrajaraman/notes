...
Now, we would like to make this continuous by making $\Delta t\to 0$. How do we do this? When the $Z_t$ are Gaussian, \Cref{eqn: discrete time stochastic localization} can be written as a stochastic differential equation
