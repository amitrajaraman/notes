\subsection{Symmetric functions}
	...
	\begin{ftheo}[Hook length formula]
		Given a cell $c$ in the Ferrer diagram of $\lambda \vdash d$, the \emph{hook} at cell $c$ consists of $c$, cells to the right of $c$, and cells below $c$. Denote by $h_c$ the size of the hook at $\lambda$. Then,
	...
	We also get that $\sum f_\lambda$ is the number of involutions in $\mathfrak{S}_n$.