...
\subsection{Symmetric functions in $n$ variables}
	...
	\begin{proof}
		...
		% \lambda = 5 3 2 1
		% \mu = 3 2 2 1 1 1 1
		% x_1^3 x_2^2 x_1 to x_1^8 x_2^5 x_3^3 x_4^1
		...
		% 5
		% 6
		% (the first column has 1s at rows 1,2,3,5,6)

		% shape \lambda' and content \mu

		% not valid! However, this contributes 0 because (x_1^3 x_2^2 x_3)(x_1x_2x_3)(x_1x_3)... gets equal exponent of x_2, x_3
		% in fact, this is valid iff it forms an SSYT
	\end{proof}
