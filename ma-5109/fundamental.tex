\section{Fundamental Results in Extremal Graph Theory}
	...
	\subsection{Szemer\'{e}di's Regularity Lemma}
		...
		\subsubsection{Interesting corollaries}
			...
			This is weaker than the original result we saw since here, $t$ is fixed, and as a result cannot grow to the $\log n$ estimate we gave earlier.
			...
			\begin{proof}[Alternate proof of \nameref{theo: erdos-stone v2}]
				...
				Let $H$ be a graph on $[k]$ with vertex set $\{V_i : 1 \le i \le k\}$, and $V_i V_j \in E(H)$ iff $(V_i,V_j)$ is $(\varepsilon/8)$-regular with density at least $\varepsilon/4$.\\
