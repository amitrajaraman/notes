\section{Fundamental Results in Extremal Graph Theory}
	...
	\subsection{Pseudorandomness}
		...
		\begin{ftheo}
			\label{ftheo: eigen pseudorandom}
		...
		\begin{proof}
			...
			Observe that $d$ is an eigenvalue of $A$ with corresponding eigenvector $\mathbf{1}$, the all $1$s vector. In fact, $d$ is the largest eigenvalue (Why?). Letting $J$  be the all $1$s matrix of appropriate size,
			\begin{align*}
		...
		\begin{proof}
			...
			\begin{itemize}
				...
				% \item $C_4$-$\mathsf{Count}$ to $\mathsf{Eigen}$. Exactly as above, we have
				% \[ \sum_{i=1}^n \lambda_i^4 = (1+o(1)) n^4 p^4. \]
			\end{itemize}
