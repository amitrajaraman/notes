...
\subsection{Poles and singularities}
	...
	\begin{proof}
		...
		Define $h(z) = 1/f(z)$ on some $B(a,R)^*$ where $f$ is nowhere $0$. It is not too difficult to show using \Cref{theo 4.1} that $h$ has a removable singularity at $z = a$. Thus, there exists analytic $h_1 : B(a,R) \to \C$ such that $h_1 = 1/f$ on $B(a,R)^*$. Further, let $m \ge 1$ such that $h_1(z) = (z-a)^m h_2(z)$, where $h_2(a) \ne 0$ and $h_2$ is analytic on $B(a,R)$.\\
...
\subsection{Laurent Series}
	...
	\begin{ftheo}[Casorati-Weierstrass Theorem]
