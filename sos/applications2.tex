...
\subsection{Global correlation rounding}
	...
	\end{fdef}
	Note here that we are using $\I$ despite $\mu$ being a pseudodistribution because \Cref{prop:marginal-facts}(c) implies that the marginal $\restr{\mu}{\{i,j\}}$ is indeed a distribution (this uses that the degree of $\mu$ is at least $4$).\\
