...
% \end{exercise}
% \begin{solution*}
% 	This problem can alternatively thought of as follows: given a finite set $X$ and a set $\mathcal{S}$ of subsets of $X$, determine the smallest $\mathcal{A}\subseteq\mathcal{S}$ such that $\bigcup_{A\in\mathcal{A}} A = X$. This reformulation can be done by setting $X$ to be the set of all finite intersections of elements of $\mathcal{S}$.
% \end{solution*}
