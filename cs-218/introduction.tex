...
\paragraph{Prefix-free encoding.} One idea is to encode the letters such that each has a unique prefix. Consider
...
\paragraph{Greedy Strategy II.} This is known as the \textit{top-down strategy}. Divide the letters into two sets of almost equal frequencies. Recursively code the two sets, giving a shorter prefix to the more frequent of the two sets. It turns out that this isn't optimal either.\\ % *** GIVE A COUNTEREXAMPLE. ***
