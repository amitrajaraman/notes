...
% \end{exercise}
% \begin{solution*}
% 	Assume without loss of generality that the jobs are ordered in non-increasing order of $t_2$. We claim that then, the identity permutation suffices. Let $k\in[n]$ attain the maximum described above. Let $\sigma$ be any permutation of $[n]$. 
% \end{solution*}
