...
\section{Introduction}
	...
	\subsection{Linear Regression}
		...
		Observe that if one of our basis functions is $1$ (or some non-zero constant), this is equivalent to the set of all \emph{affine} functions (linear functions plus a constant) on the remaining basis functions.
	...
	\subsection{Probabilistic Interpretations}
		...
		Let us move away from regression for a moment and look at what happens if instead of trying to learn a function with inputs and outputs, we look at the problem of determining the parameters of some random variable given some datapoints drawn from it.
...
\section{Unsupervised Learning}
	...
	\subsection{Clustering}
		...
		\subsubsection{Notions of measure}
			...
			% How do we filter out noisy dimensions that are unimportant?
