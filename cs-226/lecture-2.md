...
This is known as the $$1$$s complement system. Observe that in this case, complementing each bit of $$x$$ results in $$-x$$. The only issue that remains is that $$0$$ has two representations.

To solve this, we introduce the $$2$$s complement system, wherein for positive $$x$$, $$-x$$ is obtained by complementing (each bit of) $$x$$ and adding $$1$$. This is equivalent to subtracting the number from $$2^n$$. This is usually the preferred representation.

| $$000$$ | $$001$$ | $$010$$ | $$011$$ | $$100$$ | $$101$$ | $$110$$ | $$111$$ |
| $$0$$   | $$1$$   | $$2$$   | $$3$$   | $$-4$$  | $$-3$$  | $$-2$$  | $$-1$$  |

This is basically a fixed length representation with no explicit sign bit. It is important to note that here, there is one negative number $$-2^{n-1}$$ here with no positive counterpart. In this case, addition and subtraction are very easy as well. We just move along the dial. The same addition operation can be used to do the subtraction operation as well.

Converting binary to decimal is given by
