\section{Introduction}
	...
	\subsection{Basic Definitions}
		...
		\subsubsection{Equivalence}
			...
			From \Cref{theo: finite abelian group dual} and the final example in \Cref{ex: deg one reps of nonabelian groups}, we get the following.
		...
		\subsubsection{Decomposability}
			...
			\begin{fprop}[Irreducible representations of finite cyclic groups]
