...
\begin{prooftree}
    \LeftLabel{\textsf{RuleName}}
    \AxiomC{Stuff already there}
    \RightLabel{\textsf{Conditions to be met}}
...
\begin{prooftree}
    \LeftLabel{$\vee$-\textsf{Intro}}
    \AxiomC{$\Sigma\vdash F$}
    \UnaryInfC{$\Sigma\vdash F\vee G$}
\end{prooftree}

\begin{prooftree}
    \LeftLabel{$\vee$-\textsf{Elim}}
...
\begin{prooftree}
    \LeftLabel{$\vee$-\textsf{Symm}}
    \AxiomC{$\Sigma\vdash F\vee G$}
    \UnaryInfC{$\Sigma\vdash G\vee F$}
\end{prooftree}

\begin{prooftree}
    \LeftLabel{$\vee$-\textsf{Def}}
    \AxiomC{$\Sigma\vdash F\vee G$}
    \UnaryInfC{$\Sigma\vdash \neg(\neg F \wedge \neg G)$}
\end{prooftree}
...
\begin{enumerate}
    \item $\Sigma\vdash (F\wedge G)\vee(F\wedge H)$ \hfill (\textsf{Premise})%1
    
    \item $\Sigma\cup\{F\wedge G\} \vdash F\wedge G$ \hfill (\textsf{Assumption})%2
    \item $\Sigma\cup\{F\wedge G\} \vdash F$ \hfill (\textsf{$\wedge$-Elim} applied to 2)%3
    \item $\Sigma\cup\{F\wedge G\} \vdash G\wedge F$ \hfill (\textsf{$\wedge$-Symm} applied to 2)%4
    \item $\Sigma\cup\{F\wedge G\} \vdash G$ \hfill (\textsf{$\wedge$-Elim} applied to 4)%5
    \item $\Sigma\cup\{F\wedge G\}\vdash G\vee H$ \hfill (\textsf{$\vee$-Intro} applied to 5)%6
    \item $\Sigma\cup\{F\wedge G\}\vdash F\wedge(G\vee H)$ \hfill (\textsf{$\wedge$-Intro} applied to 3,6)%7

    \item $\Sigma\cup\{F\wedge H\} \vdash F\wedge H$ \hfill (\textsf{Assumption})%8
    \item $\Sigma\cup\{F\wedge H\} \vdash F$ \hfill (\textsf{$\wedge$-Elim} applied to 8)%9
    \item $\Sigma\cup\{F\wedge H\} \vdash H\wedge F$ \hfill (\textsf{$\wedge$-Symm} applied to 8)%10
    \item $\Sigma\cup\{F\wedge H\} \vdash H$ \hfill (\textsf{$\wedge$-Elim} applied to 10)%11
    \item $\Sigma\cup\{F\wedge H\}\vdash H\vee G$ \hfill (\textsf{$\vee$-Intro} applied to 11)%12
    \item $\Sigma\cup\{F\wedge H\}\vdash G\vee H$ \hfill (\textsf{$\vee$-Symm} applied to 11)%13
    \item $\Sigma\cup\{F\wedge G\}\vdash F\wedge(G\vee H)$ \hfill (\textsf{$\wedge$-Intro} applied to 9,13)%14

    \item $\Sigma\vdash F\wedge(G\vee H)$ \hfill (\textsf{$\vee$-Elim} applied to 1,7,14)%15
\end{enumerate}
...
\begin{prooftree}
    \LeftLabel{$\Rightarrow$-\textsf{Intro}}
    \AxiomC{$\Sigma\cup \{F\}\vdash G$}
    \UnaryInfC{$\Sigma\vdash F \Rightarrow G$}
\end{prooftree}

\begin{prooftree}
    \LeftLabel{$\Rightarrow$-\textsf{Elim}}
    \AxiomC{$\Sigma\vdash F\Rightarrow G$}
    \AxiomC{$\Sigma\vdash F$}
    \BinaryInfC{$\Sigma\vdash G$}
\end{prooftree}

\begin{prooftree}
    \LeftLabel{$\Rightarrow$-\textsf{Def}}
    \AxiomC{$\Sigma\vdash F\Rightarrow G$}
    \UnaryInfC{$\Sigma\vdash \neg F\vee G$}
\end{prooftree}
...
\begin{enumerate}
    ...
    % \item $\emptyset\vdash (\neg p)\Rightarrow (p\Rightarrow q)$ \hfill (\textsf{$\Rightarrow$-Intro} applied to 3)
    % \item $\emptyset\vdash (\neg \neg p) \vee (p\Rightarrow q)$ \hfill (\textsf{$\Rightarrow$-Def} applied to 4)
\end{enumerate}
