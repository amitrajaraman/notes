...
\subsection{Domain restriction}
	...
	\subsubsection{Mechanism design with transfers}
		...
		Over the next two examples, we more precisely look at combinatorial auctions from \Cref{ex: payment irl examples}.

		\begin{fex}[Combinatorial auctions I]
		...
		\begin{fex}[Combinatorial auctions II]
